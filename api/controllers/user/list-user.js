module.exports = {
    friendlyName: "retrieve users",
    description: "Controller to retrieve user data",
    inputs: {
        data: {
            type: {},
            example: {
    ...
    fn: async function(inputs, exits) {
        ...
        try {
            if (inputs && inputs.data) {
                ...
                userList = await sails.helpers.database.user.listUser(searchCriteria, sort, limit, skip, populate);
